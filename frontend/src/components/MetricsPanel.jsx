  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      <div className="grid lg:grid-cols-[auto_1fr] gap-6 items-center">
        <div className="nv-panel hud-corners p-6 flex flex-col items-center gap-2 relative overflow-hidden bg-black">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <p className="text-[10px] text-mute uppercase font-mono text-center max-w-[10rem] tracking-wider mt-2">Mean demotion-safety confidence across all float variables</p>
          </div>
        </div>
        <div className="grid grid-cols-2 gap-4">
          {stats.map(([label, value, sub, color], i) => (
            <motion.div
              key={label}
              className="metric-card hud-corners relative overflow-hidden bg-black p-4"
              initial={{ opacity: 0, y: 16 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: i * 0.06 }}
            >
              <GlowingEffect disabled={false} glow={true} proximity={60} spread={30} borderWidth={1.2} />
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="nv-panel hud-corners p-6 relative overflow-hidden bg-black">
          <GlowingEffect disabled={false} glow={true} proximity={80} spread={40} borderWidth={1.5} />
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="nv-panel p-6 relative overflow-hidden bg-black">
          <GlowingEffect disabled={false} glow={true} proximity={80} spread={40} borderWidth={1.5} />
          <div className="corner-square" />
          <div className="relative z-10">
      ...
      <div className="nv-panel p-6 overflow-auto relative overflow-hidden bg-black">
        <GlowingEffect disabled={false} glow={true} proximity={80} spread={40} borderWidth={1.5} />
        <div className="corner-square" />
        <div className="relative z-10">
